...
<body class="bg-light">
    <div class="container py-4">
                ...
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="my-1"><i class="fas fa-heartbeat me-2"></i> Monitor de Signos Vitales</h4>
                            <div id="signal-indicator" class="badge bg-light text-dark">
        ...
        <div class="row">
            <div class="col-lg-8 mb-4">
                <div class="card shadow h-100">
                    <div class="card-header bg-white">
                        <h5 class="my-1"><i class="fas fa-chart-line me-2"></i> Análisis en Tiempo Real Oximetro</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-4">
                <div class="card shadow mb-3 vital-card" id="spo2-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <h5><i class="fas fa-lungs me-2"></i> SpO₂</h5>
                            <div class="badge bg-light text-dark" id="spo2-status">Esperando datos...</div>
                        </div>
                        <div class="value-display text-center my-3" id="spo2-value">--
                            <span class="trend-indicator" id="spo2-trend"></span>
                        </div>
                        <div class="progress mb-2">
                            <div id="spo2-progress" class="progress-bar" role="progressbar" style="width: 0%"></div>
                        </div>
                        <small class="text-muted" id="spo2-range">Normal: 95-100%</small>
                    </div>
                </div>

                <div class="card shadow mb-3 vital-card" id="bpm-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <h5><i class="fas fa-heart me-2"></i> Frecuencia Cardíaca</h5>
                            <div class="badge bg-light text-dark" id="bpm-status">Esperando datos...</div>
                        </div>
                        <div class="value-display text-center my-3" id="bpm-value">--
                            <span class="trend-indicator" id="bpm-trend"></span>
                        </div>
                        <div class="progress mb-2">
                            <div id="bpm-progress" class="progress-bar" role="progressbar" style="width: 0%"></div>
                        </div>
                        <small class="text-muted" id="bpm-range">Normal: 60-100 bpm</small>
                    </div>
                </div>

                <div class="card shadow mb-3 vital-card" id="temp-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <h5><i class="fas fa-thermometer-half me-2"></i> Temperatura</h5>
                            <div class="badge bg-light text-dark" id="temp-status">Esperando datos...</div>
                        </div>
                        <div class="value-display text-center my-3" id="temp-value">--
                            <span class="trend-indicator" id="temp-trend"></span>
                        </div>
                        <div class="progress mb-2">
                            <div id="temp-progress" class="progress-bar" role="progressbar" style="width: 0%"></div>
                        </div>
                        <small class="text-muted" id="temp-range">Normal: 36°C - 37.5°C</small>
                    </div>
                </div>
                ...
                <div class="card shadow">
                    <div class="card-body text-center py-2">
                        <div id="measurement-guide">
                            ...
                            <p class="mb-1">Coloque el dedo en el sensor</p>
                            <small class="text-muted" id="reading-time">Tiempo de lectura: 0s</small>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="card shadow" id="diagnosis-card">
                    <div class="card-header bg-white">
                        <h5 class="my-1"><i class="fas fa-diagnoses me-2"></i> Diagnóstico Médico</h5>
                    </div>
                    <div class="card-body" id="diagnosis-content">
                        <div class="text-center text-muted py-3">
                            <i class="fas fa-sync fa-spin me-2"></i> Analizando señales biométricas...
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        async function updateDashboard() {
            try {
                const response = await fetch('http://192.168.27.135:5001/get_data');
